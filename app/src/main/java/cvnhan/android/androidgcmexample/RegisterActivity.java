...
import static cvnhan.android.androidgcmexample.CommonUtilities.SENDER_ID;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(name.trim().length() > 0 && email.trim().length() > 0){
                    ...
                    alert.showAlertDialog(RegisterActivity.this, "Registration Error!", "Please enter your details");
                }
            }
        });
    }
